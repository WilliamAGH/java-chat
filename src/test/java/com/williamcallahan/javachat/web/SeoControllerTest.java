...
class SeoControllerTest {
    ...
    void serves_root_with_seo_metadata() throws Exception {
        mvc.perform(get("/"))
                ...
                .andExpect(content()
                        .string(containsString("<title>Java Chat - AI-Powered Java Learning With Citations</title>")))
    ...
    void serves_chat_with_specific_metadata() throws Exception {
        mvc.perform(get("/chat"))
                .andExpect(status().isOk())
                .andExpect(content()
                        .string(containsString("<title>Java Chat - Streaming Java Tutor With Citations</title>")))
        ...
        mvc.perform(get("/guided"))
                ...
                .andExpect(content()
                        .string(containsString(
                                "og:description\" content=\"Structured, step-by-step Java learning paths")))
