...
public class QdrantCollectionNames {
    private String books = "java-chat-qwen3-embedding-4b-2560-books";
    private String docs = "java-chat-qwen3-embedding-4b-2560-docs";
    private String articles = "java-chat-qwen3-embedding-4b-2560-articles";
    private String pdfs = "java-chat-qwen3-embedding-4b-2560-pdfs";
