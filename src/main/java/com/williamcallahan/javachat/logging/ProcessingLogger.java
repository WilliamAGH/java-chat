...
public class ProcessingLogger {
     ...
     */
    @Around("execution(* com.williamcallahan.javachat.service.*EmbeddingClient.embed(..))")
     ...
     */
    @AfterThrowing(
            pointcut = "execution(* com.williamcallahan.javachat.service.*EmbeddingClient.embed(..))",
            throwing = "exception")
