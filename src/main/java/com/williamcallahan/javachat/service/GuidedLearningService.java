...
public class GuidedLearningService {
    ...
    private static final String OFFICIAL_DOCUMENTATION_GUIDANCE_TEMPLATE = "You are a learning assistant for %s. Use"
            ...
            + " values for retrieval-grounded factual claims: %s. If those sources do not cover an in-scope topic,"
            + " answer it from general knowledge under the core source-attribution rules. Do NOT"
