...
public class TooltipRegistry {
    ...
    public TooltipRegistry() {
        ...
        add(
                "primitive",
                "A basic value type like int, double, boolean stored directly (not an object).",
                "https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html");
        add(
                "reference",
                "A value that points to an object on the heap rather than containing the value directly.",
                "https://docs.oracle.com/javase/specs/");
        add(
                "variable",
                "A named storage location with a declared type that determines the kind of data it can hold.",
                "https://docs.oracle.com/javase/tutorial/java/nutsandbolts/variables.html");
        add(
                "assignment",
                "The operation of storing a value into a variable using the = operator.",
                "https://docs.oracle.com/javase/tutorial/java/nutsandbolts/op1.html");
        add(
                "autoboxing",
                "Automatic conversion between primitives and their wrapper types (e.g., int ↔ Integer).",
                "https://docs.oracle.com/javase/tutorial/java/data/autoboxing.html");
        add(
                "immutable",
                "An object whose state cannot be changed after creation (e.g., String).",
                "https://docs.oracle.com/javase/tutorial/java/nutsandbolts/strings.html");
        add(
                "record",
                "A special class that provides a compact syntax for immutable data carriers.",
                "https://docs.oracle.com/en/java/javase/24/language/records.html");
        add(
                "optional",
