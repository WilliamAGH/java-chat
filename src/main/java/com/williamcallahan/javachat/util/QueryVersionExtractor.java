...
public final class QueryVersionExtractor {
    ...
    private static final Pattern EXPLICIT_QUANTITY_SUFFIX_PATTERN = Pattern.compile(
            "[\\s-]+(?:days?|hours?|minutes?|seconds?|times|lines?|weeks?|months?|years?)\\b",
    ...
    public static List<String> extractVersionNumbers(String query) {
        ...
        Matcher quantitySuffixMatcher = EXPLICIT_QUANTITY_SUFFIX_PATTERN.matcher(query);
