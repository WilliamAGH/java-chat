...
Read the [Groovy 5.0.7 language documentation](https://docs.groovy-lang.org/docs/groovy-5.0.7/html/documentation/) for the official syntax, semantics, and Java integration reference.
