...
Read the official [Quarkus getting-started guide](https://quarkus.io/guides/getting-started) for the framework's project, CDI, configuration, REST, and test conventions.
