...
fetch_named_official_source() {
    ...
    case "$source_identifier" in
        ...
        docker) "$source_dispatch" fetch_source --url "https://docs.docker.com/" --mirror-path "docker" --name "Docker Documentation" --source-version "current" --identity-regex "Docker" --cut-directories 0 --minimum-html-files 1600 --seed-document-type xml-sitemap --seed-discovery-url "https://docs.docker.com/sitemap.xml" --seed-source-prefix "https://docs.docker.com/" --seed-reject-regex '^https://docs\.docker\.com/(build/(buildkit/dockerfile-release-notes|release-notes)|enterprise/security/provisioning/scim|reference/(api/(dvp/latest|engine/version/v1\.[0-9]+|hub/latest|registry/latest)|cli/docker/(build|builder/build|exec|images|info|mcp/(feature|tools)/list|ps|pull|push|run))|scout/release-notes/cli)/$' ;;
        javachat-cli) "$source_dispatch" fetch_source --url "https://www.npmjs.com/package/@wcallahan/javachat-cli" --mirror-path "javachat-cli" --name "JavaChat CLI 0.0.1 Package Documentation" --source-version "0.0.1-8b26605fce31" --identity-regex "JavaChat CLI" --cut-directories 0 --minimum-html-files 1 --plain-text-document-url "https://raw.githubusercontent.com/WilliamAGH/java-chat/8b26605fce3102f90b7c127284509528dc868fa7/cli/README.md" --plain-text-document-title "JavaChat CLI 0.0.1 Package Documentation" --minimum-plain-text-bytes 4000 --plain-text-required-text "# JavaChat CLI" --plain-text-required-text "@wcallahan/javachat-cli" ;;
        mintlify) "$source_dispatch" fetch_source --url "https://www.mintlify.com/llms.txt" --mirror-path "mintlify" --name "Mintlify Documentation Index" --source-version "current" --identity-regex "Mintlify" --cut-directories 0 --minimum-html-files 1 --plain-text-document-url "https://www.mintlify.com/llms.txt" --plain-text-document-title "Mintlify Documentation Index" --minimum-plain-text-bytes 5000 --plain-text-required-text "# Mintlify" --plain-text-required-text "https://www.mintlify.com/docs/llms.txt" ;;
        fern) "$source_dispatch" fetch_source --url "https://buildwithfern.com/llms.txt" --mirror-path "fern" --name "Fern Documentation Index" --source-version "current" --identity-regex "Fern Documentation" --cut-directories 0 --minimum-html-files 1 --plain-text-document-url "https://buildwithfern.com/llms.txt" --plain-text-document-title "Fern Documentation Index" --minimum-plain-text-bytes 40000 --plain-text-required-text "# Fern Documentation" --plain-text-required-text "https://buildwithfern.com/learn/llms.txt" ;;
        temporal) "$source_dispatch" fetch_source --url "https://temporal.io/llms.txt" --mirror-path "temporal" --name "Temporal Documentation Index" --source-version "current" --identity-regex "Temporal" --cut-directories 0 --minimum-html-files 1 --plain-text-document-url "https://temporal.io/llms.txt" --plain-text-document-title "Temporal Documentation Index" --minimum-plain-text-bytes 11000 --plain-text-required-text "# Temporal" --plain-text-required-text "https://docs.temporal.io/llms.txt" ;;
        clerk) "$source_dispatch" fetch_source --url "https://clerk.com/docs/" --mirror-path "clerk" --name "Clerk Documentation" --source-version "current" --identity-regex "Clerk" --cut-directories 1 --minimum-html-files 1 --plain-text-document-url "https://clerk.com/docs/llms-full.txt" --plain-text-document-title "Clerk Documentation" --minimum-plain-text-bytes 500000 --plain-text-required-text "# Clerk" ;;
        ...
        porkbun) "$source_dispatch" fetch_source --url "https://porkbun.com/api/json/v3/documentation" --mirror-path "porkbun" --name "Porkbun API v3.16 Documentation" --source-version "3.16" --identity-regex 'Porkbun API v3.*v3\.16|v3\.16.*Porkbun API' --required-identity-page "index.html" --required-identity-text "Porkbun API v3 — v3.16" --cut-directories 0 --minimum-html-files 1 --plain-text-document-url "https://porkbun.com/llms-full.txt" --plain-text-document-title "Porkbun API v3.16 Documentation" --minimum-plain-text-bytes 125000 --plain-text-required-text "# Porkbun API v3 — v3.16" --plain-text-required-text "## AI agents (MCP)" --plain-text-required-text "npx -y @porkbunllc/mcp-server" --plain-text-required-text "Retrieve all DNS records" --llm-sentinel-url "https://porkbun.com/llms.txt" --minimum-llm-sentinel-bytes 18000 --llm-sentinel-required-text "# Porkbun" --llm-sentinel-required-text "## Official MCP server" --llm-sentinel-required-text "https://porkbun.com/llms/agent-setup" ;;
        ...
        java/java26-complete) "$source_dispatch" fetch_source --java-release 26 --url "https://docs.oracle.com/en/java/javase/26/docs/api/" --mirror-path "java/java26-complete" --name "Java 26 Complete API" --source-version "26-ga" --identity-regex "Overview \\(Java SE 26 &amp; JDK 26\\)" --required-identity-page "api/index.html" --required-identity-text "Overview (Java SE 26 & JDK 26)" --cut-directories 5 --minimum-html-files 5000 ;;
...
fetch_all_official_sources() {
    ...
    for source_identifier in dev-java kotlin scala groovy clojure \
        ...
        docker javachat-cli mintlify fern temporal \
        clerk traefik dokploy infisical doppler-guides doppler-reference doppler-changelog \
