<script lang="ts">
    ...
    interface Props {
        ...
        messageRenderer?: Snippet<
            [{ message: ChatMessage; index: number; isStreaming: boolean }]
        >;
        ...
        /** Number of unseen content updates. */
        unseenCount?: number;
        onToggle: () => void;
        onClose: () => void;
        onClear: () => void;
...
{#if isOpen}
    ...
    <div class="chat-drawer" role="dialog" aria-label="Lesson chat">
        ...
        <div class="chat-drawer-messages-wrapper">
            <div
                class="chat-drawer-messages"
            ...
            >
                {#if messages.length === 0 && !isStreaming}
                    <div class="chat-empty">
                        <p>
                            Have questions about <strong
                                >{emptyStateSubject}</strong
                            >?
                        </p>
                        <p class="hint">
